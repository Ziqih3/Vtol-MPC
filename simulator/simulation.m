classdef simulation < handle
    ...
    methods
        ...
        function NextStepControlAllocation(obj, time)
            ...
            plantinput = plant_input(obj.Multirotor.NumOfRotors, obj.Multirotor.NumOfServos);
            [rotor_speed_squared, deflections,tilt,~] = obj.Controller.ControlAcceleration(obj.Multirotor, lin_acc_des, euler_acc_des);
...
%             logger.Add(logger_signals.PlantInputCommand, plantinput);
        ...
        function NextStepServoController(obj,time)
            ...
            if abs(angleerr(1)) <= max_change(1)
                servoangles(1) = obj.Multirotor.Servos{1}.TiltAngle;
            elseif angleerr > max_change(1)
            ...
            if abs(angleerr(2)) <= max_change(2)
                servoangles(2) = obj.Multirotor.Servos{2}.TiltAngle;
            elseif angleerr > max_change(2)
...
%             servoangles(cond) = obj.Multirotor.Servos{1}.TiltAngle;
...
%             last_time = time;
        ...
        function success = NextSimulationStep(obj,plantinput)
            % set up wait bar
...
%%%%%%%%%%%%%%%%%%%%%
    ...
    methods (Access = private)
        function [contact_status, contact_normal, contact_wrench, rot_ic] = ...
            ...
            %hard coded air_velocity
            %air_velocity = [27.329; 0; 0];  
