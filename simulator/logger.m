classdef logger < handle
    ...
    methods(Static)
        ...
        function [data, times] = GetLeftAileronAngle()
            [measured_data, times] = logger.GetMeasuredStates();
            data = cell2mat(cellfun(@(s)s.AileronLeftPos', measured_data, 'uni', 0));
        end
        
        function [data, times] = GetLeftAileronRate()
            [measured_data, times] = logger.GetMeasuredStates();
            data = cell2mat(cellfun(@(s)s.AileronLeftRate', measured_data, 'uni', 0));
        end
        
        function [data, times] = GetRightAileronAngle()
            [measured_data, times] = logger.GetMeasuredStates();
            data = cell2mat(cellfun(@(s)s.AileronRightPos', measured_data, 'uni', 0));
        end
        
        function [data, times] = GetRightAileronRate()
            [measured_data, times] = logger.GetMeasuredStates();
            data = cell2mat(cellfun(@(s)s.AileronRightRate', measured_data, 'uni', 0));
        end
        ...
        function [data, times] = GetAeroMoments()
            [measured_data, times] = logger.GetMeasuredStates();
            data = cell2mat(cellfun(@(s)s.AeroMoments', measured_data, 'uni', 0));
        end
        ...
        function [data, times, labels] = GetField(str)
            ...
            elseif contains(str, 'aeromoment')
                [data, times] = logger.GetAeroMoments();
                labels = {'x','y','z','AeroMoments'};
            elseif contains(str, 'laileronp')
                [data, times] = logger.GetLeftAileronAngle();
                labels = {'LeftAileronPose','LeftAileronPose'};
            elseif contains(str, 'laileronr')
                [data, times] = logger.GetLeftAileronRate();
                labels = {'Left Aileron Rate', 'Left Aileron Rate'};
            elseif contains(str, 'raileronp')
                [data, times] = logger.GetRightAileronAngle();
                labels = {'Right Aileron Pose', 'Right Aileron Pos'};
            elseif contains(str, 'raileronr')
                [data, times] = logger.GetRightAileronRate();
                labels = {'Right Aileron Rate','Right Aileron Rate'};
