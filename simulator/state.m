classdef state < handle
    ...
    properties
        ...
        LastEulerRate      = zeros(3, 1);         % Last state eulerrate(For MPC state update)
        LastThrust          = zeros(3,1);         % Last state thrust(For MPC state update)
    ...
    methods
        ...
        function CopyFrom(obj, s)
            ...
            obj.LastEulerRate       = s.LastEulerRate;
            obj.LastThrust          = s.LastThrust;
            ...
            obj.AeroMoments         = s.AeroMoments;
            
            obj.Throttle = s.Throttle;
        end
        
        function s = struct(obj)
            s.Acceleration        = obj.Acceleration;
            s.EulerRate           = obj.EulerRate;
            s.LastEulerRate       = obj.LastEulerRate;
            s.LastThrust          = obj.LastThrust;
            ...
            s.AeroMoments         = obj.AeroMoments;
            
            s.Throttle = obj.Throttle;
        end
    end
end
